...
void exportSmartEquilibriumResult(py::module& m)
{
    py::class_<SmartEquilibriumTiming>(m, "SmartEquilibriumTiming")
        ...
        .def_readwrite("learning_storage", &SmartEquilibriumTiming::learn_storage, "The time spent in seconds for storing the computed chemical state into the tree of knowledge.")
