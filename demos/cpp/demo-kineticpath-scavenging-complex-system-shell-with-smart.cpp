...
int main()
{
    ...
    //smart_kinetic_options.tol = 1e-3; // too inaccurate
    smart_kinetic_options.tol = 1e-4; // way better
    ...
    bool use_smart_kinetic_solver = true;
...
//    getchar();
    ...
    kinetic_path_options.use_smart_kinetic_solver = use_smart_kinetic_solver;
