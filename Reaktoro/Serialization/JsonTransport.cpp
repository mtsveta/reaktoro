...
void to_json(json& j, const ReactiveTransportAnalysis& obj) {
    ...
    j["computing_costs_per_time_step"]["smart_kinetics_learn_chemical_properties"] = obj.computing_costs_per_time_step.smart_kinetics_learn_chemical_properties;
    j["computing_costs_per_time_step"]["smart_kinetics_estimate"] = obj.computing_costs_per_time_step.smart_kinetics_estimate;
    j["computing_costs_per_time_step"]["smart_kinetics_estimate_search"] = obj.computing_costs_per_time_step.smart_kinetics_estimate_search;
...
void from_json(const json& j, ReactiveTransportAnalysis& obj) {
    ...
    j.at("computing_costs_per_time_step").at("smart_kinetics_estimate_search").get_to(obj.computing_costs_per_time_step.smart_kinetics_estimate_search);
    j.at("computing_costs_per_time_step").at("smart_kinetics_learn").get_to(obj.computing_costs_per_time_step.smart_kinetics_learn);
    j.at("computing_costs_per_time_step").at("smart_kinetics_learn_chemical_properties").get_to(obj.computing_costs_per_time_step.smart_kinetics_learn_chemical_properties);
