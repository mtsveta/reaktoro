    ...
    auto stepKinetics(ChemicalField& field) -> ReactiveTransportResult
    {
        ...
        if(options.use_smart_kinetic_solver)
        {
            ...
            for(Index icell = 0; icell < num_cells; ++icell)
            {
                ...
                //if(options.use_smart_kinetic_solver)    result.smart_equilibrium_at_cell[icell] = smart_kinetic_solver.result().smart_equilibrium;
        ...
        else
        {
            ...
            for(Index icell = 0; icell < num_cells; ++icell)
            {
                ...
                if(options.use_smart_kinetic_solver)    result.smart_equilibrium_at_cell[icell] = kinetic_solver.result().smart_equilibrium;
